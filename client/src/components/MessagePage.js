  ...
  return (
    ...
    >
      <header className="sticky top-0 h-16 bg-white flex justify-between items-center px-4">
        ...
        <div>
          <button className="cursor-pointer text-third">
            <BsThreeDotsVertical />
          </button>
        </div>
      </header>
      ...
      <section className="h-16 bg-white flex items-center px-4">
        <div className=" relative ">
          <button
            ...
            className="flex justify-center items-center w-11 h-11 rounded-full hover:bg-third hover:text-white"
          >
            <FaPlus size={20} />
          </button>
        ...
        <form className="h-full w-full flex gap-2" onSubmit={handleSendMessage}>
          ...
          />
          <button className="text-third hover:text-fourth">
            <MdSend size={28} />
          </button>
        </form>
      </section>
